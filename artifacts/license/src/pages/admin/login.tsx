...
export default function AdminLogin() {
  ...
  const [email, setEmail] = useState("nexora@localhost.com");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#080c14] px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center text-xs text-gray-600 mt-4">Customer? <a href="/portal/login" className="text-violet-400 hover:underline">Sign in here</a></p>
      </div>
    </div>
  );
}
